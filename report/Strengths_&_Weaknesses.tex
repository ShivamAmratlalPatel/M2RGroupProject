...
Certainly we can increase the rounds for exploration, but then we are wasting more number of rounds in searching randomly. This would then further hurt our total reward.
