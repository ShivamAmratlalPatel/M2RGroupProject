...
\begin{figure}[h]
    ...
    \caption[Comparison for 10 machines with random]{Comparison of Stationary Strategies. Epsilon =0.06, confidence level=1. 10 machines. 20000 rounds per iteration. Average of 50 iterations}
    \label{fig:ten_machines_all_strategies}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/comaprison_without_random_10_machines}
    \caption[Comparison for 10 machines without random]{Comparison of Stationary Strategies excluding random strategy. Epsilon =0.06, confidence level=1. 10 machines. 20000 rounds per iteration. Average of 50 iterations}
